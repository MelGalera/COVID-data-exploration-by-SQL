...
/* Note: If continent is NOT NULL then the location is by country */ 


-- PART B. Data exploration: Questions


/* Question 1: Determine COVID infection rates (Total cases vs population, or the percentage of population that contracted COVID19) 
 * worldwide, by country, by continent. Show the highest or top 10. */
...
/* Question 2: Determine COVID case fatality rates (Total deaths vs total cases, or the percentage of deaths in relation to the number of cases) 
 * worldwide, by country, by continent. Show the highest or top 10. */ 
...
/* Question 5: Determine the vaccination rate or the percentage  of population that has received at least one covid vaccine 
 * worldwide, by country, by continent. Show the highest or top 10.  */ 
